		...
		<main id="main" class="site-main">
			...
			<div class="landing-page-section hero-container" >
				...
				<div class="intro-description">
					...
					<div class="intro-description-logo">
						...
						<p>3C is a creative consultancy with a unique expertise in how people form perspective and its impact on their behaviour. We work with companies to create desired perspective and the resulting behaviour.</p>
				</div>
				<div class="logo-outline">
					<img src="http://localhost:8888/wp-content/uploads/2018/11/Asset-1.png">
				</div>
			</div>
			...
			<div class="landing-page-section culture-container three-c">
				<div class="culture three-c-description">
					...
					<p>Agreements are fundamental to human organization. They determine what’s acceptable. They define what’s expected. They   outline the operational boarders in which people work and the impacts to doing things differently.

						Understanding the implied and explicit agreements within your company allows the operational boarders in which your people currently work to be seen. This process reveals insights into why your people do what they do and allows you to see what new agreements are required to ensure you stay ahead.
			...
			<div class="landing-page-section consulting-container three-c">
				<div class="consulting three-c-description">
					...
					<p>Alignment creates organizational strength. It is what defines the speed in which your company moves. It determines effectiveness. It is the structure in which performance is achieved, and the foundation for achieving what is possible.

						Knowing the ways people are aligned with your company allows focus to be given to the ways people aren’t. Tracking the impacts to the ways your company is not aligned, makes prioritizing the areas to focus on self evident, and will allow you to stay ahead.
			...
			<div class="landing-page-section our-work-container">
				<h2>Our Work</h2>
				<div class="our-work-gallery">
					<div class="our-work-example">
						<img src="http://localhost:8888/wp-content/uploads/2018/11/gallery-image-company1.jpg">
					</div>
					<div class="our-work-example">
						<img src="http://localhost:8888/wp-content/uploads/2018/11/gallery-image-company2.jpg">
					</div>
					<div class="our-work-example">
						<img src="http://localhost:8888/wp-content/uploads/2018/11/gallery-image-company3.jpg">
					</div>
					<div class="our-work-example">
						<img src="http://localhost:8888/wp-content/uploads/2018/11/gallery-image-company4.jpg">
					</div>
					<div class="our-work-example">
						<img src="http://localhost:8888/wp-content/uploads/2018/11/gallery-image-company5.jpg">
					</div>
